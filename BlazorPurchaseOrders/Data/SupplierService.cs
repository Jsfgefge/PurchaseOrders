...
namespace BlazorPurchaseOrders.Data {
    public class SupplierService : ISupplierService {
        ...
        public async Task<int> SupplierInsert(string SupplierName, string SupplierAddress1, string SupplierAddress2, string SupplierAddress3, string SupplierPostCode, string SupplierEmail) {
            int Success = 0;
        ...
        // This only works if you're already created the stored procedure.
        public async Task<int> SupplierUpdate(int SupplierID, string SupplierName, string SupplierAddress1, string SupplierAddress2, string SupplierAddress3, string SupplierPostCode, string SupplierEmail, bool SupplierIsArchived) {
            int Success = 0;
            var parameters = new DynamicParameters();
            parameters.Add("SupplierID", SupplierID, DbType.Int32);
            parameters.Add("SupplierName", SupplierName, DbType.String);
